	...
	<div class="box-c">
		<div class="box-cnt two-columns">
			...
			<div class="side-right">
				...
				<p><?=_get_short_info($services_page->post_content)?></p>
				...
				<ul>
					...
					?>
						<li>
							...
							<div class="info">
								<a href="<?=$project_url?>" rel="nofollow" class="view">view live</a>
		...
		<div class="box-cnt two-columns">
			...
			<div class="side-left">
				...
				<div class="post">
					...
					<h2><a href="<?=$link?>"><?=$latest_post->post_title?></a></h2>
					<small><?=_format_date($latest_post->post_date)?></small>
					...
					<div class="postmeta more">
						...
						<a href="<?=$link?>#comments"><span><?=$latest_post->comment_count?> comments</span></a>
					</div>
				</div>
			</div>
	...
	<div class="box-c">
		<div class="box-cnt three-columns">
				...
				<div class="small-thumbnails">
					...
					<ul>
						...
						<?php foreach($projects as $p) : ?>
							<li><a href="<?=get_permalink($p->ID)?>"><?=_get_project_info('small_image', $p->post_content)?></a></li>
						<?php endforeach; ?>
					</ul>
					<div class="cl">&nbsp;</div>
				</div>
			...
			<div class="side-eq side-center">
				...
				<h2><?=$latest_project->post_title?> Case study </h2>
				<p><?=_get_project_info('short_info', $latest_project->post_content); ?></p>
				<p class="more"><a href="<?=get_permalink($latest_project->ID)?>"><span>read more</span></a></p>
			</div>
			<div class="side-eq">
				<h2>Your Project</h2>
